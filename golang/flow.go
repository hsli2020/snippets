...
// request context. It returns the empty string if no matching parameter is found.
...
func (m *Mux) Handle(pattern string, handler http.Handler, methods ...string) {
	...
	// Compile any regular expression patterns and add them to the compiledRXPatterns map.
