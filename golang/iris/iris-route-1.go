...
func donateFinishHandler(ctx iris.Context) {
	...
	// but iris provides an easy to do that, if donate_url is not defined, then it returns 
...
func notFoundHandler(ctx iris.Context) {
	ctx.HTML("Custom route for 404 not found http code, here you can render a view, html, 
				json <b>any valid response</b>.")
}
