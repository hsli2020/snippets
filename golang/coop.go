// coop contains some of the most commonly used concurrent flows.
// This package is mostly around for reference. even though you can use it
// as a library, I'd suggest you to implement your own control mechanisms.
package coop
...
// channel if timeout occurs. TODO: cancel if timeout occurs
...
// Starts to run the given list of fns concurrently, at most n fns at a time.
