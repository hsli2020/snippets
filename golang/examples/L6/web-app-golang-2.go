HTTP Response Snippets for Go (19th October 2013)
=============================

Taking inspiration from the Rails layouts and rendering guide, I thought it'd be a nice
idea to build a snippet collection illustrating some common HTTP responses for Go web
applications.
...
Instead of passing in the http.ResponseWriter when executing your template (like in the
above snippet) use a buffer instead:
