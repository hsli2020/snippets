...
// https://github.com/mvdan/corpus/blob/master/main.go
...
moreLoop:
	for page := 1; ; page++ {
		...
		if !query.Search.PageInfo.HasNextPage {
			...
			log.Printf("out of results at %d pages and %d modules; restarting at %d stars",
				page, len(modules), lastStarCount)
			cursor = nil
