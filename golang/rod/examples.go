...
func main() {
	...
	//Example_customize_chrome_launch()
	//Example_direct_cdp()
...
// Rod provides a lot of debug options, you can use set methods to enable them or use
...
// If a button is moving too fast, you cannot click it as a human, to perfectly simulate
// human inputs the click trigger by Rod are based on mouse point location, so usually you
// need wait a button is stable before you can click it.
...
// Useful when rod doesn't have the function you want, you can call the cdp interface
// directly easily.
