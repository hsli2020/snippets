...
//
//    See the comments below and execute echidna-test commands.
...
//
//Click here to see the default configuration
...
contract EchidnaTestTimeAndCaller {
    ...
    /* test will fail if Echidna can call setFail(), test will pass otherwise */
    ...
    // Default senders // Change the addresses to see the test fail
