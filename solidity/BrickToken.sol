/** https://bscscan.com/address/0xc4893fEa8547Fb1A4D860518285AF6655424645f#code
 * https://twitter.com/brick_bsc
...
contract BrickToken is IBEP20, Auth {
    ...
    uint256 _totalSupply = 1 * 1000000000000 * (10 ** _decimals);
    ...
    function swapBack() internal lockTheSwap {
		...
		uint256 amountBNBMarking = amountBNB.sub(amountBNBReflection).sub(amountBNBLiquidity);
