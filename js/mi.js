// https://github.com/aptuz/mi-js/blob/master/mi.0.1.js

// http://www.aptuz.com/blog/create-javascript-mvc-framework/
// http://www.aptuz.com/blog/create-mvc-framework-architect-the-structure-part2/
// http://www.aptuz.com/blog/create-mvc-frameworkimplement-the-structurepart3/

// Create Javascript MVC Framework in less than 200 lines
...
var mi = (function () {
    ...
    var resources = {
        ...
        'config': function(options) {
            ...
            resources.root = options && options.root ? '/' + 
                             resources.clearSlashes(options.root) + '/' : '/';
        },
