    ...
    function Map(iterable) {
        ...
        var MapIterator = function MapIterator(map, kind) {
            ...
            return Object.create({}, {
                ...
                toString: {
                    value: function() { return '[object Map Iterator]'; }
                }
            });
        };
        ...
        return Object.create(MapPrototype, {
             ...
             */
            items:{
                value:function() { return [].slice.call(_items); }
            },
            /**
             * @return {Array} all keys in the Map, in order
             */
            keys:{
                value:function() { return [].slice.call(_keys); }
            },
            /**
             * @return {Array} all values in the Map, in order
             */
            values:{
                value:function() { return [].slice.call(_values); }
            },
            /**
             ...
             */
            iterator:{
                value: function() { return new MapIterator(this, 'keys+values'); }
            },
            toString:{
                value: function() { return '[Object Map]'; }
            }
        });
    }
