<?php	# https://github.com/laravel/installer/src/NewCommand.php
...
class NewCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        $installJetstream = $input->getOption('jet') || (
            $input->getOption('prompt-jetstream') && 
            (new SymfonyStyle($input, $output))->confirm('Would you like to install the 
                Laravel Jetstream application scaffolding?', false)
        );
...
|______\__,_|_|  \__,_| \_/ \___|_|</>'.PHP_EOL.PHP_EOL);
     ...
     */
    protected function installJetstream(string $directory, string $stack, bool $teams,
     ...
     */
    protected function createRepository(string $directory,
        InputInterface $input, OutputInterface $output)
    {
        chdir($directory);
     ...
     */
    protected function pushToGitHub(string $name, string $directory,
        InputInterface $input, OutputInterface $output)
    {
        ...
        if (! $process->isSuccessful()) {
            $output->writeln('Warning: make sure the "gh" CLI tool is installed and that 
                you\'re authenticated to GitHub. Skipping...');
    ...
    protected function runCommands($commands,
        InputInterface $input, OutputInterface $output, array $env = [])
    {
...
# $app = new Symfony\Component\Console\Application('Laravel Installer', '4.2.12');
