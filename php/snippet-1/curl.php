...
//$r = fetchURL('http://192.168.0.12/query/shippingeasy?id=9400110200828288199666', null);
//#$r['body'] = 'SET TO EMPTY';
//$r['head'] = 'SEE headarray';

// TODO: try POST
//$r = fetchURL('http://192.168.0.116/dataexchange/autosubmit.php', [ 'Post' => "username=JOHN&password=PASS" ]);
$r = fetchURL('http://192.168.0.116/dataexchange/autosubmit.php', [ 'Post' => ["username"=>"JOHN","password"=>"PASS" ]]);
print_r($r);
