...
class User
{
    ...
    {
        if (!mysql_query("INSERT INTO $this->table (firstname,lastname,email)
    ...
    {
        if (!mysql_query("UPDATE $this->table SET firstname='$this->firstName,
            lastname=$this->lastName,email=$this->email WHERE id='$id'")) {
...
try {
    ...
    $db->insert(array('firstname'=>'Kate','lastname'=>'Johanson','email'=>'kate@domain.com'),
      'users');
}
catch(Exception $e) {
    echo $e->getMessage();
